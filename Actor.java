...
public abstract class Actor extends Sprite {
	 ...
	 * 
	 * @param others all other actors that this actor might take action on.
	 */
	...
	/**
	 * This method should be overidden in subclasses to specify boo-specific
	 * actions.
	 */
	protected abstract void actOn(Boo other);
}
